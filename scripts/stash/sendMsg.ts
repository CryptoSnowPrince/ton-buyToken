...
async function sendMessage() {
  ...
  // let messageBody = beginCell().storeUint(1, 64).storeAddress(newadminwallet).endCell(); // op with value 1 (increment)
  
  let messageBody = beginCell().storeUint(2, 64).storeUint(1, 64).storeAddress(newbot).endCell(); // op with value 1 (increment)
  // let messageBody = beginCell().storeUint(3, 64).endCell(); // op with value 1 (increment)
